...
namespace Music_Store.Classes
{
    public class Connection
    {
        ...
        // Метод для проверки логина и пароля (используем sa для проверки)
        ...
        // Метод для получения строки подключения по роли
        public string GetRoleConnection(string position)
        {
            switch (position.ToLower())
            {
                ...
                default:
                    return masterConnection; // fallback
            }
        }
